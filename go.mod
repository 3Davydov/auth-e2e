module github.com/3Davydov/auth-e2e

go 1.22.2

require github.com/testcontainers/testcontainers-go/modules/compose v0.31.0

require (
	dario.cat/mergo v1.0.0 // indirect
	github.com/3Davydov/rd-proto v1.0.0 // indirect
